...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.25]{assets/gzhu.png} %1.png是图片文件的相对路径
\end{figure}
\vspace{0.15cm}	
\centering
...
\lstinputlisting[
    % style       =   Rust,
    caption     =   {\bf udtree.rs},
    label       =   {udtree.rs}
]{assets/examplecode.rs}

\begin{figure}[H] % use H to force the figure to be placed here
	\centering
	\includegraphics[width=0.5\textwidth]{assets/gzhu.png}
	\caption{这是一张图片}
	\label{fig:1}
\end{figure}
